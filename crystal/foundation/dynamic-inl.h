...
template <>
struct hash<::crystal::dynamic> {
  size_t operator()(::crystal::dynamic const& d) const {
    return d.hash();
  }
};
...
inline dynamic::dynamic(std::string_view s)
  : type_(STRING)
{
...
inline std::string_view dynamic::view() const {
  return get<std::string>();
}
...
#define CRYSTAL_DYNAMIC_INTEGER_OP(op)                     \
...
CRYSTAL_DYNAMIC_INTEGER_OP(%=)
CRYSTAL_DYNAMIC_INTEGER_OP(|=)
CRYSTAL_DYNAMIC_INTEGER_OP(&=)
CRYSTAL_DYNAMIC_INTEGER_OP(^=)

#undef CRYSTAL_DYNAMIC_INTEGER_OP
...
#define CRYSTAL_DYNAMIC_DEC_TYPEINFO(T, str, val) \
...
CRYSTAL_DYNAMIC_DEC_TYPEINFO(std::nullptr_t,      "null",    dynamic::NULLT)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(bool,                "boolean", dynamic::BOOL)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(std::string,         "string",  dynamic::STRING)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(dynamic::Array,      "array",   dynamic::ARRAY)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(double,              "double",  dynamic::DOUBLE)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(int64_t,             "int64",   dynamic::INT64)
CRYSTAL_DYNAMIC_DEC_TYPEINFO(dynamic::ObjectImpl, "object",  dynamic::OBJECT)

#undef CRYSTAL_DYNAMIC_DEC_TYPEINFO
...
#define CRYSTAL_X(T) PrintImpl<T>::print(*this, out, *getAddress<T>())
