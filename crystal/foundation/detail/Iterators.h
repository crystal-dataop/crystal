 ...
 * crystal libs; more features will be slapped in here if and when they're needed.
 *
 ...
 *
 * These are currently only intended for use within crystal, hence their living
 * under detail.  Use outside crystal is not recommended.
 *
 * To see how to use these classes, find the instances where this is used within
 * crystal libs.  Common use cases can also be found in `IteratorsTest.cpp`.
 */
